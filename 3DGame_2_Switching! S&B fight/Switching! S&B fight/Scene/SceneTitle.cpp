...
namespace {
	const char* const kUI[13]{
		...
		"data/UI/TItleScene/説明背景.png",			// テロップ背景
		"data/UI/TItleScene/移動先1.png",			// テロップ1
		"data/UI/TItleScene/移動先2.png",			// テロップ2
		"data/UI/TItleScene/移動先3.png",			// テロップ3
		"data/UI/TItleScene/移動先4.png",			// テロップ4
	...
	constexpr float kBgScroll1 = 1.5f;		// テロップスクロール移動量
