...
namespace
{
	...
	constexpr float kDeathEffectScale = 8.0f;	// 死亡時エフェクトの拡大率
	constexpr int kDeathEffectTime = 10;		// 死亡時エフェクトの再生時間
	constexpr float kDeathEffectSpeed = 3.0f;	// 死亡時エフェクトの再生速度
}
